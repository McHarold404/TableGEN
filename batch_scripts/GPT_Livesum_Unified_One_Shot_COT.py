...
def process_atomic_generation(model_dir, model_name, full_length=754):
    ...
    output_path = f"./model_outputs/Livesum/{model_dir}/TabGen_Unified_One_Shot_COT/"
    ...
    for idx in range(0,full_length):
        ...
        # Call Gemini model
        atomic_out = ask_chatgpt(text=df['text'][idx], prompt_path=prompt_path, model_name=model_name)
